...
RK_ERR kModuleInit(RK_MODULE *const, BYTE *const, ULONG const, CHAR *const);
VOID *kModuleAlloc(RK_MODULE *const, ULONG const, ULONG const);
RK_STACK *kModuleStackAlloc(RK_MODULE *const, ULONG const);
RK_ERR kModuleTaskInit(RK_MODULE *const,
                       RK_TASK_HANDLE *,
                       const RK_TASKENTRY, VOID *,
                       CHAR *const,
                       const ULONG, const RK_PRIO,
...
RK_ERR kModuleMapSharedRegion(RK_MODULE *const, RK_SHARED_REGION *const);
RK_ERR kTaskInitModule(RK_TASK_HANDLE *,
                       const RK_TASKENTRY, VOID *,
                       CHAR *const, RK_STACK *const,
                       const ULONG, const RK_PRIO,
                       const RK_OPTION, RK_MODULE *const);

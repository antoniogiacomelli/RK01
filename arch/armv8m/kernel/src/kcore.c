...
/*
 * File intent:
 *   ARMv8-M core and MPS2 board bring-up. This file owns clock resolution,
 *   exception priorities, SysTick programming, critical sections and reset
 *   helpers.
 *
...
/*
 * ARMv8-M stores interrupt priorities in the upper implemented bits of each
